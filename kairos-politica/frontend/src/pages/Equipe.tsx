...
const empty = { name: "", email: "", password: "", role: "assessor", active: true };
const roleLabel: Record<string, string> = { admin: "Administrador", vereador: "Vereador", assessor: "Assessor", cidadao: "Cidadão" };
