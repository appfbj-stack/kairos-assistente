...
const navItems = [
  ...
  { label: "Atendimento IA", href: "/atendimento/dashboard", icon: MessageSquare, group: "tools" },
  { label: "Assistentes", href: "/atendimento/assistentes", icon: Bot, group: "tools" },
  { label: "Base de Conhecimento", href: "/atendimento/conhecimento", icon: BookOpen, group: "tools" },
  { label: "Conversas", href: "/atendimento/conversas", icon: MessageSquare, group: "tools" },
